...
class Heroe(Personaje): 
     ...
     def __init__ (self, nombre, clase, nivel = 1): 
            ...
            if self.clase =="guardiana del bosque":
              salud_max = 120
              fuerza = 15 
              defensa = 8 
            elif self.clase == "alquimista del aire": 
             salud_max = 80
             fuerza =20
             defensa =4
            elif self.clase == "viajero del sueño":
             salud_max = 95
             fuerza = 13
             defensa = 6 
            elif self.clase == "mecánica errante":
             salud_max = 100
             fuerza = 12
             defensa = 7
            else: 
     ...
     def ganar_experiencia(self, cantidad): 
            ...
            if self.experiencia >= experiencia_necesaria: 
                ...
                print(f"{self.nombre} ha alcanzado el Nivel: {self.nivel}! La energía del bosque la fortalece.")
